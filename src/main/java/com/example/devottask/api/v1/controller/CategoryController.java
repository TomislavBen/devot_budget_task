...
public class CategoryController {
    ...
    @PostMapping
    public ResponseEntity<Category> createCategory(@Valid @RequestBody CreateCategoryRequest CreateCategoryRequest) throws Exception{
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Category> updateCategory(@PathVariable Long id, @RequestBody UpdateCategoryRequest updateCategoryRequest) throws Exception{
      Category category = categoryRepo.findByIdAndAccount(id, accountService.checkAccount());
